 ...
 */
public class EventsFragments extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//        String url = "http://api.androidhive.info/volley/person_object.json";
        String url = "http://demo.peacenepal.com/kvc/college/api/events";
        Log.d(TAG, "up to here...");
                        ...
                        if (response != null){
                            try {
                                ...
                                try {
                                    ...
                                    about_us = jsonObject.getJSONArray("events");
                                    Log.d(TAG, String.valueOf(about_us));
                                    ...
                                    for (int i=0; i<about_us.length(); i++) {
                                        ...
                                        String attach = object.getString("news_attachment");

                                        currentMap.put("title", title);
                                        currentMap.put("body", body);
                                        currentMap.put("date", date);
                                        currentMap.put("description", description);
                                        currentMap.put("attach", "http://demo.peacenepal.com/kvc/college/uploads/news/" +attach);


                                        EventsFragmentAdapter adapter = new EventsFragmentAdapter(getActivity(), results);
