 ...
 */
public class ManagemenntFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
                        ...
                        try {
                            ...
                            if (response != null){
                                try {
                                    ...
                                    JSONArray jsonArray2 = jsonObject3.getJSONArray("+2 MANAGEMENT");
