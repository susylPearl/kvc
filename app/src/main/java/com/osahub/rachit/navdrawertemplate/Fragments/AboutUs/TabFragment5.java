 ...
 */
public class TabFragment5 extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
                                ...
                                try {
                                    ...
                                    for (int i=0; i<about_us.length(); i++) {
                                        ...
                                        if (id == 32 ) {
                                            ...
                                            String[] urls = {"http://demo.peacenepal.com/kvc/uploads/images/3bb5cec99f4b4f2f155bb46227bf20a5(2).jpg",
                                                    "http://demo.peacenepal.com/kvc/uploads/images/200002c9664fef2d22ccd7db2e76ebb1(4).jpg"};
