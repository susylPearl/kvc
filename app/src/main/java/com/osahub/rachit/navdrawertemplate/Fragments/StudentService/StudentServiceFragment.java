...
import com.osahub.rachit.navdrawertemplate.Adapters.StudentServicePagerAdapter;
...
//                                JSONObject jsonObject3 = jsonArray1.getJSONObject(0);
                                ...
                                for (int i=0; i<keys.length; i++) {
                                    ...
                                    final StudentServicePagerAdapter adapter = new StudentServicePagerAdapter
                                            (((NavActivity) getActivity()).getSupportFragmentManager(), tabLayout.getTabCount());
