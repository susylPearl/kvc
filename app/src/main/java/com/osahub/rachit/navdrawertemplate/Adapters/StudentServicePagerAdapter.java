 ...
 */
public class StudentServicePagerAdapter extends FragmentStatePagerAdapter {

    int mNumOfTabs;
    public StudentServicePagerAdapter(FragmentManager fm, int NumOfTabs) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case 0:
                FacilitiesFragment tab1 = new FacilitiesFragment();
                return tab1;
            case 1:
                StudentClubFragment tab2 = new StudentClubFragment();
                return tab2;
//            case 2:
